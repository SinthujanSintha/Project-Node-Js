...
module.exports = function (app, passport) {
  ...
  app.get('/employeeList',isLoggedIn, function (req, res) {
    ...
    con.query("SELECT * FROM user u,employee_job e ,salary s where u.Type='Employee' and u.user_Id=e.Emp_Id and e.Salary_Id=s.Salary_Id", function (err, result, fields) {
      con
      if (err) throw err;
